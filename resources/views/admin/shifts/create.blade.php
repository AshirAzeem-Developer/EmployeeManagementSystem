            ...
            <form action="{{ route('admin.shifts.store') }}" method="POST">
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-2xl mb-8">
                    ...
                    <div class="bg-gradient-to-r from-primary-600 to-indigo-600 px-6 py-4">
                        <h3 class="text-lg font-bold text-white">Shift Details</h3>
                        <p class="text-primary-100 text-sm">Define a new work shift schedule.</p>
                    </div>
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="input-enhanced w-full rounded-lg border-gray-300 shadow-sm sm:text-sm" required placeholder="e.g. Morning Shift">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="time" name="start_time" id="start_time" value="{{ old('start_time') }}" class="input-enhanced w-full rounded-lg border-gray-300 shadow-sm sm:text-sm" required>
                            ...
                            <div>
                                ...
                                <input type="time" name="end_time" id="end_time" value="{{ old('end_time') }}" class="input-enhanced w-full rounded-lg border-gray-300 shadow-sm sm:text-sm" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="grace_period_minutes" id="grace_period_minutes" value="{{ old('grace_period_minutes', 0) }}" min="0" class="input-enhanced w-full rounded-lg border-gray-300 shadow-sm sm:text-sm" required>
