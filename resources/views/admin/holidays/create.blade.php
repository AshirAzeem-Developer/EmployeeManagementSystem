            ...
            <form action="{{ route('admin.holidays.store') }}" method="POST">
                ...
                <div class="bg-white overflow-hidden shadow-lg sm:rounded-2xl mb-8">
                    ...
                    <div class="bg-gradient-to-r from-primary-600 to-indigo-600 px-6 py-4">
                        <h3 class="text-lg font-bold text-white">Holiday Details</h3>
                        <p class="text-primary-100 text-sm">Add a new holiday to the calendar.</p>
                    </div>
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <input type="date" name="date" id="date" value="{{ old('date') }}" class="input-enhanced w-full rounded-lg border-gray-300 shadow-sm sm:text-sm" required>
